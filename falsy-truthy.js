// When you evaluate an expression sometimes they will return absolute true or false 
...
if (NaN)        {} else { console.log('NaN is falsy'); } // NaN = not a number
...
if ('pug')          { console.log('a non-empty string is truthy')}
...
if (1.23)           { console.log('positive floats are truthy'); } // floats = values after the decimal point
